...
public class BannerPostRearAttachment extends RearAttachment {
    private static final Text UI_TITLE = Text.translatable("container.motobox.banner_post");
    ...
    public BannerPostRearAttachment(RearAttachmentType<?> type, VehicleEntity entity) {
        super(type, entity);
    }
