...
public enum VehicleHud {
    ...
    public static void render(MatrixStack matrices, PlayerEntity player, VehicleEntity vehicle, float tickDelta) {
        renderSpeedometer(matrices, vehicle);
    ...
    private static void renderSpeedometer(MatrixStack matrices, VehicleEntity vehicle) {
